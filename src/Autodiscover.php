...
namespace JamesIArmes\ExchangeWebServices;

use JamesIArmes\ExchangeWebServices\Connection;
use JamesIArmes\ExchangeWebServices\Autodiscover;
 ...
 *
 * $auto = new ExchangeWebServices\Autodiscover($email, $password);
...
class Autodiscover
{
    ...
    public function parseServerVersion($version_hex)
    {
        ...
        if ($majorversion == 8) {
            switch ($minorversion) {
                case 0:
                    return Connection::VERSION_2007;
                    break;
                case 1:
                    return Connection::VERSION_2007_SP1;
                    break;
                case 2:
                    return Connection::VERSION_2007_SP2;
                    break;
                case 3:
                    return Connection::VERSION_2007_SP3;
                    break;
                default:
                    return Connection::VERSION_2007;
            }
            ...
            switch ($minorversion) {
                case 0:
                    return Connection::VERSION_2010;
                    break;
                case 1:
                    return Connection::VERSION_2010_SP1;
                    break;
                case 2:
                    return Connection::VERSION_2010_SP2;
                    break;
                default:
                    return Connection::VERSION_2010;
            }
    ...
    public function newEWS()
    {
        ...
        if ($server) {
            if ($version === null) {
                // EWS class default.
                $version = Connection::VERSION_2007;
            }
